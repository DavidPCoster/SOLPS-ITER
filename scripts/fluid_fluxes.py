...
if vreg == 2:
  ...
  print('South(%s--%s) = %0.6e' % (species[S],species[E],SOUTH))
  print('North(%s--%s) = %0.6e' % (species[S],species[E],NORTH))
  print('East(%s--%s) = %0.6e' % (species[S],species[E],EAST))
  print('West(%s--%s) = %0.6e' % (species[S],species[E],WEST))
  print('Ext(%s--%s) = %0.6e' % (species[S],species[E],EXT))
  print('Sum(%s--%s) = %0.6e' % (species[S],species[E],SUM))
  ...
  print('Core(%s--%s) = %0.6e' % (species[S],species[E],CORE))
  print('Sep(%s--%s) = %0.6e' % (species[S],species[E],SEP))
  print('North(%s--%s) = %0.6e' % (species[S],species[E],NORTH))
  print('East(%s--%s) = %0.6e' % (species[S],species[E],EAST))
  print('east(%s--%s) = %0.6e' % (species[S],species[E],east))
  print('west(%s--%s) = %0.6e' % (species[S],species[E],west))
  print('West(%s--%s) = %0.6e' % (species[S],species[E],WEST))
  print('Pflxl(%s--%s) = %0.6e' % (species[S],species[E],PFLXL))
  print('Pflxr(%s--%s) = %0.6e' % (species[S],species[E],PFLXR))
  print('Ext(%s--%s) = %0.6e' % (species[S],species[E],EXT))
  print('Sum(%s--%s) = %0.6e' % (species[S],species[E],SUM))
  print('ExtCore(%s--%s) = %0.6e' % (species[S],species[E],EXTCORE))
  print('SumCore(%s--%s) = %0.6e' % (species[S],species[E],CORE-SEP+EXTCORE))
  ...
  print('Pflxl(%s--%s) = %0.6e' % (species[S],species[E],PFLXL))
  print('Pflxr(%s--%s) = %0.6e' % (species[S],species[E],PFLXR))
  print('Island(%s--%s) = %0.6e' % (species[S],species[E],ISLAND))
  print('Ext(%s--%s) = %0.6e' % (species[S],species[E],EXT))
  print('Sum(%s--%s) = %0.6e' % (species[S],species[E],SUM))
  print('ExtCore(%s--%s) = %0.6e' % (species[S],species[E],EXTCORE))
  print('SumCore(%s--%s) = %0.6e' % (species[S],species[E],CORE-SEP+EXTCORE))
  ...
  print('Core(%s--%s) = %0.6e' % (species[S],species[E],CORE))
  print('Sep(%s--%s) = %0.6e' % (species[S],species[E],SEP))
  print('North1(%s--%s) = %0.6e' % (species[S],species[E],NORTH1))
  print('East1(%s--%s) = %0.6e' % (species[S],species[E],EAST1))
  print('east1(%s--%s) = %0.6e' % (species[S],species[E],east1))
  print('west1(%s--%s) = %0.6e' % (species[S],species[E],west1))
  print('West1(%s--%s) = %0.6e' % (species[S],species[E],WEST1))
  print('North2(%s--%s) = %0.6e' % (species[S],species[E],NORTH2))
  print('East2(%s--%s) = %0.6e' % (species[S],species[E],EAST2))
  print('east3(%s--%s) = %0.6e' % (species[S],species[E],east3))
  print('East3(%s--%s) = %0.6e' % (species[S],species[E],EAST3))
  print('Pflxl(%s--%s) = %0.6e' % (species[S],species[E],PFLXL))
  print('Pflxr1(%s--%s) = %0.6e' % (species[S],species[E],PFLXR1))
  print('Pflxr2(%s--%s) = %0.6e' % (species[S],species[E],PFLXR2))
  print('Ext(%s--%s) = %0.6e' % (species[S],species[E],EXT))
  print('Sum(%s--%s) = %0.6e' % (species[S],species[E],SUM))
  print('ExtCore(%s--%s) = %0.6e' % (species[S],species[E],EXTCORE))
  ...
  print('Core1(%s--%s) = %0.6e' % (species[S],species[E],CORE1))
  print('Sep1(%s--%s) = %0.6e' % (species[S],species[E],SEP1))
  print('North1(%s--%s) = %0.6e' % (species[S],species[E],NORTH1))
  print('East1(%s--%s) = %0.6e' % (species[S],species[E],EAST1))
  print('east1(%s--%s) = %0.6e' % (species[S],species[E],east1))
  print('west1(%s--%s) = %0.6e' % (species[S],species[E],west1))
  print('West1(%s--%s) = %0.6e' % (species[S],species[E],WEST1))
  print('Core2(%s--%s) = %0.6e' % (species[S],species[E],CORE2))
  print('Sep2(%s--%s) = %0.6e' % (species[S],species[E],SEP2))
  print('North2(%s--%s) = %0.6e' % (species[S],species[E],NORTH2))
  print('East2(%s--%s) = %0.6e' % (species[S],species[E],EAST2))
  print('east2(%s--%s) = %0.6e' % (species[S],species[E],east2))
  print('west2(%s--%s) = %0.6e' % (species[S],species[E],west2))
  print('West2(%s--%s) = %0.6e' % (species[S],species[E],WEST2))
  print('Ext(%s--%s) = %0.6e' % (species[S],species[E],EXT))
  print('Sum(%s--%s) = %0.6e' % (species[S],species[E],SUM))
  print('ExtCore(%s--%s) = %0.6e' % (species[S],species[E],EXTCORE))
  print('SumCore(%s--%s) = %0.6e' % (species[S],species[E],CORE1+CORE2-SEP1-SEP2+EXTCORE))

# print('SumSOL(%s--%s) = %0.6e' % (species[S],species[E],SEP-numpy.sum(fnayreg[-1,S:E+1,6],axis=0)+west+east))
